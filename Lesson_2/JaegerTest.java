public class JaegerTest {
    public static void main(String[] args) {
        ...
        System.out.println("Strenght: " + (jaegerChernoAlpha.getStrength()));
        System.out.println("Speed: " + (jaegerChernoAlpha.getSpeed()));
        System.out.println("Amour: " + (jaegerChernoAlpha.getaAmor()));
        System.out.println();
        
        Jaeger jaegerCoyoteTango = new Jaeger("Coyote Tango", "Mark-1",
                76.2f, 2.312f, 7, 5, 4);
        ...
        System.out.println("Strenght: " + (jaegerCoyoteTango.getStrength()));
        System.out.println("Speed: " + (jaegerCoyoteTango.getSpeed()));
        System.out.println("Amour: " + (jaegerCoyoteTango.getaAmor()));
    }
}